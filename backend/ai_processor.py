...
"""
            ...
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert job analyst specializing in identifying automation opportunities in accounting and financial services roles."},
...
"""
            ...
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert at matching accounting and financial services jobs to AI automation agents. Be precise and analytical in your matching."},
                    {"role": "user", "content": prompt}
                ],
                temperature=0.2,
                max_tokens=500
...
"""
            ...
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert in AI agent development for accounting and financial services. Focus on practical automation opportunities."},
                    {"role": "user", "content": prompt}
                ],
                temperature=0.4,
                max_tokens=300
